    ...
    return <div className="bonus-div">
        ...
        <div className='flex-box-button-2'>
            <div>
                ...
                <a href="https://ks.renai.us/viewtopic.php?f=52&t=9187"><button className='button-choice-low'><FontAwesomeIcon icon={faFeather} />  Learning to Fly</button></a>
            </div>
            <div>
                <p>Emi's Epilogue by Mountaineer</p>
                <a href="https://docs.google.com/document/d/1B9HKGprGPDz8rKdzqBIuRcsA6aWPTZZm_LXQ8OUKoTI/edit"><button className='button-choice-low'><FontAwesomeIcon icon={faLemon} />  Ascent</button></a>
            </div>
            <div>
                <p>Saki's Sprites</p>
